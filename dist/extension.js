...
const commitSuggester_1 = __webpack_require__(2);
function activate(context) {
    const command = vscode.commands.registerCommand('commitElaborator.suggestMessage', async () => {
        ...
        if (!diff) {
            vscode.window.showWarningMessage('Nenhuma mudança staged encontrada. Adicione arquivos com "git add" antes.');
            return;
        }
        await vscode.window.withProgress({
            ...
            const model = config.get('model') || 'claude-haiku-4-5-20251001';
            const language = config.get('language') || 'pt-BR';
            const convention = config.get('convention') || 'conventional';
            if (!apiKey) {
                vscode.window.showErrorMessage('Chave de API Anthropic não configurada. Defina em Configurações > Commit Elaborator > Anthropic Api Key ou na variável ANTHROPIC_API_KEY.');
                return;
            }
            try {
                const suggestion = await (0, commitSuggester_1.suggestCommitMessage)({ diff, apiKey, model, language, convention });
...
async function pickRepository(repos) {
...
const sdk_1 = __importDefault(__webpack_require__(3));
...
async function suggestCommitMessage(options) {
...
const Errors = __importStar(__webpack_require__(66));
const Pagination = __importStar(__webpack_require__(70));
const Uploads = __importStar(__webpack_require__(69));
const API = __importStar(__webpack_require__(71));
const completions_1 = __webpack_require__(81);
const models_1 = __webpack_require__(85);
const beta_1 = __webpack_require__(73);
const messages_1 = __webpack_require__(82);
/**
...
const error_1 = __webpack_require__(66);
const index_1 = __webpack_require__(7);
const uploads_1 = __webpack_require__(69);
var uploads_2 = __webpack_require__(69);
...
const index_1 = __webpack_require__(7);
const error_1 = __webpack_require__(66);
const line_1 = __webpack_require__(67);
const stream_utils_1 = __webpack_require__(68);
const core_1 = __webpack_require__(4);
const error_2 = __webpack_require__(66);
class Stream {
...
var beta_1 = __webpack_require__(73);
Object.defineProperty(exports, "Beta", ({ enumerable: true, get: function () { return beta_1.Beta; } }));
var completions_1 = __webpack_require__(81);
Object.defineProperty(exports, "Completions", ({ enumerable: true, get: function () { return completions_1.Completions; } }));
var messages_1 = __webpack_require__(82);
Object.defineProperty(exports, "Messages", ({ enumerable: true, get: function () { return messages_1.Messages; } }));
var models_1 = __webpack_require__(85);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Beta = void 0;
const resource_1 = __webpack_require__(74);
const ModelsAPI = __importStar(__webpack_require__(75));
const models_1 = __webpack_require__(75);
const MessagesAPI = __importStar(__webpack_require__(76));
const messages_1 = __webpack_require__(76);
...
const resource_1 = __webpack_require__(74);
const core_1 = __webpack_require__(4);
const pagination_1 = __webpack_require__(70);
...
const resource_1 = __webpack_require__(74);
const BatchesAPI = __importStar(__webpack_require__(77));
const batches_1 = __webpack_require__(77);
const BetaMessageStream_1 = __webpack_require__(79);
...
const core_1 = __webpack_require__(4);
const pagination_1 = __webpack_require__(70);
const jsonl_1 = __webpack_require__(78);
const error_1 = __webpack_require__(66);
...
const batches_1 = __webpack_require__(83);
const MessageStream_1 = __webpack_require__(84);
var MessageStream_2 = __webpack_require__(84);
